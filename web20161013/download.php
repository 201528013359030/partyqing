	...
	<div class="moGrid">		
		<div class="header">							                          
			...
			<p class="lead">                
				...
				<span class="fl corDate">2016-01-14</span> <span class="fl corFocus">111</span>
			</p>
		</div>
	</div>
	<div class="moGrid">	
		<div class="content">
			...
			<p>			
			<p>两学一做学习系列六</p><p><iframe src="http://player.youku.com/embed/XMTUzOTQ4Njk3Ng==" frameborder="0" width="100%" name="divvideocontent" scrolling="no"></iframe></p>			</p>
...
<input type="hidden" id="attach_count" value="11"></input>
