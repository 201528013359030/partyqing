		...
		//alert($("#searchtitle").val());
			...
			if(list.length){				
				for (i=0; i<list.length; i++) {
					...
					iteam.innerHTML ="<a href='index.php?r=admin/guizhang/index&id="+list[i].id+"'><div class='img2 frame-square0'> <div class='crop0'>"+pic+"</div>"+video+"</div><div class='content'><span class='word'>"+list[i].title+"</span><span class='word0'>"+list[i].sender+"</span><span class='word0 right0'>"+list[i].time+"</span></div></a>";						
...
<div id="myCarousel" class="carousel slide">
  ...
  <?php if($key==0):?>
      ...
      <?endif?>
      <a href="index.php?r=admin/guizhang/index&id=<?=$value['id']?>"><div class="crop">
      <?php if($value['pic2']=="1"):?>
      <img style="height:100%" src="<?=$value['pic']?>" alt="slide">
      <?php else:?>
