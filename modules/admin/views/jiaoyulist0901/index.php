...
.word{display:inline-block;height:42px;width:100%;font-size:11pt;color:#262626;text-overflow: -o-ellipsis-lastline;  
overflow: hidden;  
...
<div id="myCarousel" class="carousel slide">
  ...
  <?php if($key==0):?>
      ...
      <div class="item">
      <?endif?>
      <a href="index.php?r=admin/jiaoyu/index&id=<?=$value['id']?>"><img class="img0" src="<?=$value['pic']?>" alt="slide"></a>
      </div>
  <?endif?>    
  <? endforeach?>  
   </div>
