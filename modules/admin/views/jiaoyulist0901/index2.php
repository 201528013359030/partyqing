		...
		//alert($("#searchtitle").val());
			...
			if(list.length){				
				for (i=0; i<list.length; i++) {
					...
					iteam.innerHTML ="<a href='index.php?r=admin/jiaoyu/index&id="+list[i].id+"'><div class='img2'><img class='img1' src='../web/images/2.jpg'/><div class='img5'><img class='img3' src='../web/img/play.png'/></div></div><div class='content'><span class='word'>"+list[i].title+"</span><span class='word0'>"+list[i].sender+"</span><span class='word0 right0'>"+list[i].time+"</span></div></a>";						
...
<div class="contentbig">
  <a href="index.php?r=admin/jiaoyu/index&id=<?=$value['id']?>">
    ...
    <div class="content">
        ...
        <span class="word0 right0"><?=$value['time']?><i class="ficon ic_eye"></i>
        <?=$value['readd']?></span>        
    </div>
  </a>
</div>
