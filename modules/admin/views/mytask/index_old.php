...
var myScroll,
	...
	generatedCount = 0;
var myDate = new Date();
var now= myDate.getFullYear()+'-'+(myDate.getMonth()+1 < 10 ? '0'+(myDate.getMonth()+1) : date.getMonth()+1)+'-'+ (myDate.getDate() < 10 ? '0'+(myDate.getDate()) :myDate.getDate());  
		...
		var s=$("#s").val();
			...
			if(list.length){				
				for (i=0; i<list.length; i++) {
                  ...
                  iteam.innerHTML = url+"<p class='listInfo'><span class='title'><img src='../web/img/sanjiao.png' style='height:12px;margin-bottom:3px;'>"+list[i].content+"</span></p><p class='listInfo'><span class='date'>考核日期："+time0+"</span>"+comment+"</p></a>";
