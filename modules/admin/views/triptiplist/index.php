...
<table border="1" cellpadding="10"> 
   <tr> 
     <td style="border-left:1px solid #fff;"><span style="color:#fd7474;">火车</span><img src="../web/img/train.png" style="margin-bottom:7px;margin-left:5px;vertical-align:bottom;height:25px;">
     </br><span style="display:inline-block;margin-top:10px;color:#8d8d8d;line-height:20px;"><?=$value['traffic']['train']?></span>
     </td> 
     <td><span style="color:#fd7474;">轮船</span><img src="../web/img/lc.png" style="margin-bottom:7px;margin-left:5px;vertical-align:bottom;height:25px;">
             </br><span style="display:inline-block;margin-top:10px;color:#8d8d8d;line-height:20px;"><?=$value['traffic']['ship']?></span></td>  
     <td style="border-right:1px solid #fff;"><span style="color:#fd7474;">飞机</span><img src="../web/img/plane.png" style="margin-bottom:7px;margin-left:5px;vertical-align:bottom;height:25px;">
