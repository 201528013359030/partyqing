...
<body class="bg_white" style="background-color: #efefef">	
   <div class="moGrid" style="width:100%;background-color: #fff;text-align:right;padding-bottom:0px;">
	...
	<div class="moGrid">
		<div class="btnBox">                    
			<a id="sendBtn" href="javascript:void(0);" class="btnIteam btnSubmit" style="text-decoration:none;background-color: #ff7777;width:90%;-webkit-border-radius:13px;border-radius: 13px;" onclick='cancel();'>							
