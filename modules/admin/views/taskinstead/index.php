...
function pullUpAction () {	
		...
		var s=$("#s").val();
			$.get("index.php?r=admin/taskinstead/getdata",{s:$("#s").val()
		},function(data){
			//alert(333);
			...
			if(list.length){				
				...
				if(list[i].editflag=="0"||list[i].editflag=="2"){	
                    if(list[i].taskstate=="0"){
                       ...
                       url="<a href='index.php?r=admin/taskdetail/index&instead=1&id="+list[i].taskId+"' class='listInner'>";
                       ...
                       comment ="";                                                                                                           
	             	    ...
	             	    comment="<span class='righttip color3'>待修改</span>"; 
	                    url="<a href='index.php?r=admin/taskalter/index&id="+list[i].taskId+"' class='listInner'>";
	             }                         
                    //console.log(now);  
                  ...
                  iteam.innerHTML =url+"<p class='listInfo'><span class='title'><img src='../web/img/sanjiao.png' style='height:12px;margin-bottom:3px;'>"+list[i].content+"</span><span style='display:inline-block;color:#999'>("+list[i].name+")</span></p><p class='listInfo'><span class='date'>考核日期："+time0+"</span>"+comment+"</p></a>";
...
<div id="scroller">
	...
	<div class="moBox">
		<div id="listBox" class="listBox">
			...
			<?php if($value['editflag']=="0"):?> 		
		          <?php if($value['taskstate']=="0"):?> 
				  <a href="index.php?r=admin/taskdetail/index&instead=1&id=<?=$value['taskId']?>" class="listInner">  								 
			 ...
			 <?endif?>     				     
                    ...
                    <span style="display:inline-block;color:#999">(<?=$value['name']?>)</span>
					</p>					
					<p class="listInfo">
...
$(function(){
   ...
   // alert(count);
	...
	$("#left1").click(function() {
		window.location.replace("index.php?r=admin/taskinstead/index&s=1&uid=<?=$uid?>");
	});
	$("#right1").click(function() {
		window.location.replace("index.php?r=admin/taskinstead/index&s=2&uid=<?=$uid?>");
	});
});
</script>