...
$(function(){
	 ...
	 var count=$("#count").val();
		...
		$("#left1").click(function() {
			window.location.replace("index.php?r=admin/jiaoyulist/index&s=1&zhuantiid=<?=$zhuantiid?>");
		});
		$("#right1").click(function() {
			window.location.replace("index.php?r=admin/jiaoyulist/index&s=2&zhuantiid=<?=$zhuantiid?>");
		});
 });
document.getElementById('searchtitle').addEventListener('input', function(e){
//     var value = e.target.value;
	//alert("3355");
	$.get("index.php?r=admin/jiaoyulist/search",{searchtitle:$("#searchtitle").val(),s:<?=$s?>,zhuantiid:<?=$zhuantiid?>
	},function(data){
	    //alert(JSON.stringify(data));
		var list=eval(data);
		//var relation;
