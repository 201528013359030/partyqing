...
//    public $layout  = 'layout';
    ...
    {  
       ...
       // Yii::app()->user->setFlash('success','操作成功');
        ...
        $instead=\yii::$app->request->get('instead');
       // echo $id;
        //$uid="8@3";
        ...
        $sql="SELECT name FROM memberlist WHERE guid='".$info['reporterId']."'";
        $command = $connection->createCommand($sql);
        $name0 = $command->queryOne();
        $name=$name0['name'];
        return $this->render('index', [
                'info'=>$info, 'zp' => $zp,'name' => $name,'taskId' => $id,'instead' => $instead,'model' => $model,'sendSucceed'=>$sendSucceed,
            ]);
    }
