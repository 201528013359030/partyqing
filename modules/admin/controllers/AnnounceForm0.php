 ...
 */
class AnnounceForm0 extends Model
{
	public $announceId;
	public $type;
	public $title;
	...
	//		$this->enterprisIP = $enterpris->ip;
        ...
        file_put_contents("/usr/local/www/nginx/html/notice/wt.txt", date("D M d H:i:s Y") . " =======fffff=========" .json_encode($uids), FILE_APPEND);
       // if(isset($data['texting'])){
        /************发短信begin**************/
      ...
      */  //file_put_contents("/usr/local/www/nginx/html/notice/wt.txt", date("D M d H:i:s Y") . " =======fffff=========" .json_encode($pc)."\n", FILE_APPEND);
      ...
      /*  for($i=0;$i<count($uids);$i++){
        	 ...
        	 file_put_contents("/usr/local/www/nginx/html/notice/wt.txt", date("D M d H:i:s Y") . " =======fffff=========" .json_encode($data9)."\n", FILE_APPEND);        	 
        } */      
      //  }
        /************发短信end**************/
		return 1;
