...
.word{display:inline-block;height:45px;width:100%;font-size:1em;color:#262626;}
...
function pullUpAction () {
 	...
 	setTimeout(function () {	
		...
		$.get("index.php?r=admin/jiaoyulist/getdata",{
		},function(data){
// 			alert(data);
			...
			if(list.length){								
				for (i=0; i<list.length; i++) {
                    ...
                    iteam.innerHTML ="<a href='index.php?r=admin/jiayu/index&id=1'><div class='img2'><img class='img1' src='../web/images/2.jpg'/><div class='img5'><img class='img3' src='../web/img/play.png'/></div></div><div class='content'><span class='word'>"+list[i].title+"</span><span class='word0'>"+list[i].sender+"</span><span class='word0 right0'>"+list[i].time+"</span></div></a>";
...
<ul class="example-orbit-content" data-orbit >
  <li>
  <a href="index.php?r=admin/jiayu/index&id=1" >
	...
	$.get("index.php?r=admin/jiaoyulist/search",{searchtitle:$("#searchtitle").val()
		...
		if(list.length){           //如果获得了数据			
			for (i=0; i<list.length; i++) {
				iteam = document.createElement('div');
				iteam.className = 'contentbig';           	
                iteam.innerHTML ="<a href='index.php?r=admin/jiaoyu/index&id=1'><div class='img2'><img class='img1' src='../web/images/2.jpg'/><div class='img5'><img class='img3' src='../web/img/play.png'/></div></div><div class='content'><span class='word'>"+list[i].title+"</span><span class='word0'>"+list[i].sender+"</span><span class='word0 right0'>"+list[i].time+"</span></div></a>";
