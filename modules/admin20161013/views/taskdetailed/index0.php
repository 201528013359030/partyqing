...
function getCheckeds()
{
    ...
    var id = "";
    var photo = "";
    if(notes.length>1){alert("只能选择一人审核！");return;}
    for (var i = 0; i < notes.length; i++)
    {
    	if(notes[i].data.id){
	        text += notes[i].data.text + ",";
...
<div id="wrap" class="wrap">
	...
	<div class="moGrid">
		<div class="formBox">			
   <div class="moGrid" style="width:100%">		
		<div class="header">
			<h4><?=$info['content']?></h4>
			...
			<!--end 结束附件框-->
            <hr>
                                <h4 style="margin-bottom: 15px;">汇报对象</h4>
	...
	<div class="moGrid">
		<div class="btnBox">                    
			<a id="sendBtn" href="javascript:void(0);" class="btnIteam btnSubmit" style="text-decoration:none;background-color: #ffacad;width:90%;-webkit-border-radius:10px;
border-radius: 10px;" onclick='send_submit();'>							
		...
		<div class="modal-content">
			...
			<div class="modal-body" style='height:350px;'>	
				<div style="width:100%; height:320px; margin:auto; #float:left; clear:both; border:1px solid #ccc; overflow:auto;  ">
					...
					<ul id="tree" style="min-width:300px"></ul>
				</div> 
			</div>
