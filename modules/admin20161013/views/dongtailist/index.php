		...
		//alert($("#searchtitle").val());
			...
			if(list.length){				
				for (i=0; i<list.length; i++) {
					...
					iteam.innerHTML ="<a href='index.php?r=admin/dongtai/index&id="+list[i].id+"'><div class='img2'><img class='img1' src='"+list[i].pic+"'/>"+video+"</div><div class='content'><span class='word'>"+list[i].title+"</span><span class='word0'>"+list[i].sender+"</span><span class='word0 right0'>"+list[i].time+"</span></div></a>";						
...
<div id="myCarousel" class="carousel slide">
  ...
  <?php if($key==0):?>
      ...
      <div class="item">
      <?endif?>
      <a href="index.php?r=admin/dongtai/index&id=<?=$value['id']?>"><img class="img0" src="<?=$value['pic']?>" alt="slide"></a>
      </div>
  <?endif?>    
  <? endforeach?>  
   </div>
...
//     var value = e.target.value;
	//alert("3355");
	$.get("index.php?r=admin/dongtailist/search",{searchtitle:$("#searchtitle").val()
	},function(data){
	    //alert(JSON.stringify(data));
		var list=eval(data);
		//var relation;
